...
int main(int argc, char** argv) {
  ...
  // Create a publisher that can publish a std_msgs::Float64 message on 
  //the /simple_arm/joint_1_position_controller/command topic
  ros::Publisher joint1_pub = n.advertise<std_msgs::Float64>("/simple_arm/joint_1_position_controller/command", 10);
  // Create a publisher that can publish a std_msgs::Float64 message on 
  //the /simple_arm/joint_2_position_controller/command topic
