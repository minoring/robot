...
std::vector<float> clamp_at_boundaries(float requested_j1, float requested_j2) {
  // Define clamped joint angles and assign them to the requested one
  ...
  // Get joiunts min and max parameters
...
int main(int argc, char** argv) {
  ...
  // Define two publishers to publish std_msgs::Float64 messages on joints
  // respective topics
